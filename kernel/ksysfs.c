...
static ssize_t
gentle_fair_sleepers_show(struct kobject *kobj, struct kobj_attribute *attr,
				char *buf)
{
...
static ssize_t
gentle_fair_sleepers_store(struct kobject *kobj, struct kobj_attribute *attr,
				const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
static ssize_t
arch_power_show(struct kobject *kobj, struct kobj_attribute *attr,
				char *buf)
{
	return sprintf(buf, "%u\n", Larch_power);
}
...
static ssize_t
arch_power_store(struct kobject *kobj, struct kobj_attribute *attr,
				const char *buf, size_t count)
{
	unsigned int input;
	int ret;
...
/* Initialize sched_features sysfs folder */
